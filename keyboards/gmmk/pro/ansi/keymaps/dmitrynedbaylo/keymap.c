...
//      LCtrl     LWin     LAlt                                Space                               Fn2       RAlt     Fn3       Left     Down     Right
        KC_LCTL,  KC_LGUI, KC_LALT,                            LCTL_T(KC_SPC),                     MO(_FN2), KC_RALT, MO(_FN3), KC_LEFT, KC_DOWN, KC_RGHT
    ),
...
//      LShift                 Z        X        C        V        B        N        M        ,        .             /                 RShift   Up       End
        KC_LSFT,               KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,       KC_SLSH,          KC_RSFT, KC_UP,   KC_END,
//      LCtrl         LWin     LAlt                                Space                               Fn2           RAlt     Fn3      Left     Down     Right
        KC_LCTL,      KC_LGUI, KC_LALT,                            KC_SPC,                             MO(_WIN_FN1), KC_RALT, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
    ),
...
//      LCtrl    LWin     LAlt                                Space                               Fn2           RAlt     Fn3      Left     Down     Right
        KC_LCTL, KC_LCTL, KC_LSFT,                            KC_SPC,                             MO(_GTA_FN1), KC_LALT, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
    ),
